...
import { UserLogin } from '../../redux/redux/userSlice';
...
const Login = () => {
    ...
    return (
        <div className='bg-bgColor w-full h-[100vh] flex items-center justify-center p-2'>
            <div className='w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex bg-primary rounded-xl overflow-hidden shadow-xl'>
                ...
                <div className='w-full lg:w-1/2 h-full p-10 2xl:px-20 flex flex-col justify-center'>
                    <div className='w-full flex  gap-2 items-center mb-6'>
                        <div className='w-full flex gap-2 items-center mb-6'>
                            <div className='p-2 bg-[#065ad8] rounded text-white'>
                                <img src={BgImage} alt="" width={32} height={32}/>
                            </div>
                            <span className='text-2xl text-[#065ad8] font-extrabold'>Social Media</span>
                        </div>
                    </div>
                    ...
                    <form className='py-8 flex flex-col gap-5' onSubmit={handleSubmit(onSubmit)}>      
                        ...
                        <div className='text-sm text-right text-blue font-semibold'>
                        ...
                        { isSubmitting ? (
                            ...
                            (
                                <CustomButton 
                                    type="submit"
                                    containerStyles={`inline-flex justify-center rounded-md bg-blue px-6 py-3 text-sm font-medium text-white outline-none`}
                                    title='Login'
                                />
                    ...
                    <h6>Note: You can use this existing account</h6>
                    <p>pmq28434@gmail.com | 123456</p>
                    </div>
